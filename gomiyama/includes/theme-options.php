...
/* Homepage */			
    ...
    $options[] = array( 'name' => __( 'Products', 'woothemes' ),
    					'type' => 'subheading' );
	$options[] = array( 'name' => __( 'Display latest products', 'woothemes' ),
    					'desc' => __( 'Display latest products on the homepage?', 'woothemes' ),
    					'id' => $shortname.'_homepage_products',
    					'std' => 'true',
    					'class' => 'collapsed',
    					'type' => 'checkbox' );
    $options[] = array( 'name' => __( 'Display how many products?', 'woothemes' ),
						'desc' => __( 'Specify how many products should appear on the homepage.', 'woothemes' ),
